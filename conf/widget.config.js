...
module.exports = {
  ...
  MUSIC_PLAYER_AUDIO_LIST: [
    // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      url: 'https://music.163.com/song/media/outer/url?id=2135692870.mp3',
      cover:
        'http://p1.music.126.net/iCpzMatNqnemDC12kDVRkw==/109951169412429747.jpg'
    },
    {
      name: '你的记忆',
      artist: '川村ゆみ',
      url: 'https://music.163.com/song/media/outer/url?id=403180.mp3',
      cover:
        'http://p1.music.126.net/1u0epGLkeAEez46pY-sTAw==/737772302249800.jpg'
    }
  ],
